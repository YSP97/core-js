...
// - textContent
first.textContent = '안녕하세요?'; // setter
...
/* hidden -------------------------------------------------------------- */
// css 파일에 적용한 게 우선시 되어 hidden값이 적용 안됨
...
// gsap 사용 시 css 애니메이션 사용하면 안됨!
gsap.to('h1', {
  opacity: 0, //autoAlpha: opacity와 유사한데 visibility가 바뀜
  duration: 0.5,
  repeat: -1, //negative infinity
  yoyo: true, // 팍 사라지는 게 아니라 자연스럽게
});