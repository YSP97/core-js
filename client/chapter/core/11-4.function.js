...
memoFibo.cache = {}; // 함수도 객체니까 프로퍼티로 객체를 저장할 수 있다!, 변수의 중복 막을 수 있고 유지보수도 편하니까 따로 객체로 빼는것보다 편하고 좋다~
memoFibo(10);
console.log(memoFibo.cache);
...
// 객체안에 객체안에 객체가 있는 개체에서 value만 뽑기
const randomUser = {
  gender: 'female',
